...
path1='L:\mastermatrix_matfiles_ssp_output_folder_10thmay2021\95new\';
hh=dir(path1);
...
for model=1:27
    ...
    savename=['L:\map_matrix\severity_model_wise\parameters\95new\','CDHW_all_parameter_model_',modelname(end-6:end-4),'.mat'];

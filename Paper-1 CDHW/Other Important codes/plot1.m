...
for ssp=1
    ...
    for model=5:9
        ...
        save(strcat('L:\map_matrix\ssp\',scenario(ssp,:),'\',hhh(model+2).name,'\cdhwr_spatial.mat'),'cdhwr','cdhw','hwv');
        ...
        %%save it
        save(strcat('L:\map_matrix\ssp\',scenario(ssp,:),'\',hhh(model+2).name,'\cdhwr_spatial_avg.mat'),'spcdhwr','spcdhw','sphwv');
        toc
    end
end

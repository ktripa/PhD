...
writematrix(round(finale,2),...
    'L:\codes_paper1\supplimentary_plots\Data_for_supplimentary_plots\Absolute_CDHWe_matrix95.txt','delimiter','\t');
...
% finale(:,9)=nanmean(nevent_ff(16+modelid,:),1)';
% writematrix(round(finale,2),...
%     'L:\map_matrix\severity_model_wise\plot2_values\cdhwevents_peryear_matrix\Absolute_CDHWe_matrix95.txt','delimiter','\t');
...
writematrix(round(finald,2),...
    'L:\codes_paper1\supplimentary_plots\Data_for_supplimentary_plots\Absolute_CDHWd_matrix95.txt','delimiter','\t');
...
finals(:,8)=nanmean(nsev_ff(8+modelid,:),1)'+finals(:,3);
finals(:,9)=nanmean(nsev_ff(16+modelid,:),1)'+finals(:,3);
finals(:,9)=finals(:,9)*1.5;
writematrix(round(finals,2),...
    'L:\codes_paper1\supplimentary_plots\Data_for_supplimentary_plots\Absolute_CDHWs_matrix95.txt','delimiter','\t');
